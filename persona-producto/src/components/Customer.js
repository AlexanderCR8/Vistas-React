...
const url= "http://localhost:8082/customers"
...
export default class Customer extends Component {
    state={
      ...
      return (
        <div className="App">
          <br></br>
          <button className="btn btn-success" onClick={()=>{this.setState({formCustomer:null,tipoModal:'insertar'}); this.modalInsertarCusomer()}}> Agregar Customers</button>
          <br/> <br/>
          <table className="table">
            ...
            <tbody>
              ...
              <Modal isOpen={this.state.modalInsertarCusomer}>
                  <ModalHeader>
                    <span style={{float:'right'}} onClick={()=>this.modalInsertarCusomer()}>x</span>
                  </ModalHeader>
                  <ModalBody>
